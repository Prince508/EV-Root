...
public abstract class k0 {
    ...
    public static final class c extends b {
        ...
        */
        public int b(java.lang.CharSequence r8, byte[] r9, int r10, int r11) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.k0.c.b(java.lang.CharSequence, byte[], int, int):int");
        }
        ...
        */
        public int d(int r7, byte[] r8, int r9, int r10) {
            ...
            L1c:
                ...
                r9 = r8[r9]
                if (r7 < r10) goto L31
                int r7 = androidx.datastore.preferences.protobuf.k0.a(r0, r9)
                return r7
            L31:
                r5 = r9
                r9 = r7
            ...
            L49:
                ...
                r1 = r8[r9]
                if (r7 < r10) goto L5a
                int r7 = androidx.datastore.preferences.protobuf.k0.a(r0, r1)
                return r7
            L5a:
                r9 = 0
                goto L62
            ...
            L62:
                ...
                r7 = r8[r7]
                if (r9 < r10) goto L6f
                int r7 = androidx.datastore.preferences.protobuf.k0.b(r0, r1, r7)
                return r7
            L6f:
                r5 = r9
                r9 = r7
            ...
            L86:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.k0.c.d(int, byte[], int, int):int");
        }
    }
        ...
        */
        public static int f(byte[] r10, long r11, int r13) {
            ...
            L9:
                ...
                if (r13 <= 0) goto L1a
                long r4 = r11 + r2
                byte r1 = androidx.datastore.preferences.protobuf.j0.s(r10, r11)
                if (r1 < 0) goto L19
                int r13 = r13 + (-1)
                r11 = r4
                goto L9
            ...
            L29:
                ...
                if (r1 < r0) goto L39
                long r2 = r2 + r11
                byte r11 = androidx.datastore.preferences.protobuf.j0.s(r10, r11)
                if (r11 <= r6) goto L37
                goto L39
            L37:
                r11 = r2
            ...
            L48:
                int r13 = r13 + (-3)
                long r2 = r2 + r11
                byte r0 = androidx.datastore.preferences.protobuf.j0.s(r10, r11)
                if (r0 > r6) goto L64
                r7 = -96
                if (r1 != r4) goto L57
                if (r0 < r7) goto L64
            ...
            L5d:
                long r11 = r11 + r8
                byte r0 = androidx.datastore.preferences.protobuf.j0.s(r10, r2)
                if (r0 <= r6) goto L7
            L64:
                return r5
            L65:
            ...
            L6d:
                ...
                r0 = 3
                long r11 = r11 + r0
                byte r0 = androidx.datastore.preferences.protobuf.j0.s(r10, r8)
                if (r0 <= r6) goto L7
            L8f:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.k0.e.f(byte[], long, int):int");
        }
        ...
        public static int h(byte[] bArr, int i3, long j3, int i4) {
            ...
            if (i4 == 1) {
                return k0.j(i3, j0.s(bArr, j3));
            }
            if (i4 == 2) {
                return k0.k(i3, j0.s(bArr, j3), j0.s(bArr, j3 + 1));
            }
        ...
        public String a(byte[] bArr, int i3, int i4) {
            ...
            while (i3 < i5) {
                int i8 = i3 + 1;
                byte s4 = j0.s(bArr, i3);
                if (a.n(s4)) {
                    int i9 = i7 + 1;
                    a.i(s4, cArr, i7);
                    while (i8 < i5) {
                        byte s5 = j0.s(bArr, i8);
                        if (!a.n(s5)) {
                            break;
                        }
                        i8++;
                    ...
                    int i10 = i3 + 2;
                    i3 += 3;
                    a.j(s4, j0.s(bArr, i8), j0.s(bArr, i10), cArr, i7);
                    i7++;
                } else {
                    if (i8 >= i5 - 2) {
                        throw C0335v.c();
                    }
                    byte s6 = j0.s(bArr, i8);
                    int i11 = i3 + 3;
                    byte s7 = j0.s(bArr, i3 + 2);
                    i3 += 4;
                    a.h(s4, s6, s7, j0.s(bArr, i11), cArr, i7);
                    i7 += 2;
                }
            }
            return new String(cArr, 0, i7);
        ...
        public int b(CharSequence charSequence, byte[] bArr, int i3, int i4) {
            ...
            while (i6 < length) {
                ...
                if (charAt2 < 128 && j6 < j7) {
                    ...
                    if ((charAt2 >= 55296 && 57343 >= charAt2) || j6 > j7 - 3) {
                        ...
                        if (i7 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                j0.H(bArr, j6, (byte) ((codePoint >>> 18) | 240));
                                j0.H(bArr, j6 + j4, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j8 = j6 + 3;
                                j0.H(bArr, j6 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                j6 += 4;
                                j0.H(bArr, j8, (byte) ((codePoint & 63) | 128));
                                i6 = i7;
                            } else {
                                i6 = i7;
                            }
                    ...
                    j0.H(bArr, j6, (byte) ((charAt2 >>> '\f') | 480));
                    long j9 = j6 + 2;
                    j5 = j7;
                    j0.H(bArr, j6 + j4, (byte) (((charAt2 >>> 6) & 63) | 128));
                    j6 += 3;
                    j0.H(bArr, j9, (byte) ((charAt2 & '?') | 128));
                } else {
                    j4 = j3;
                    long j10 = j6 + j4;
                    j0.H(bArr, j6, (byte) ((charAt2 >>> 6) | 960));
                    j6 += 2;
                    j0.H(bArr, j10, (byte) ((charAt2 & '?') | 128));
                    j5 = j7;
                }
                i6++;
                j3 = j4;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:34:0x0058, code lost:
            ...
            if (androidx.datastore.preferences.protobuf.j0.s(r12, r0) > (-65)) goto L38;
         */
        /* JADX WARN: Code restructure failed: missing block: B:55:0x009e, code lost:
        
            if (androidx.datastore.preferences.protobuf.j0.s(r12, r0) > (-65)) goto L59;
         */
        @Override // androidx.datastore.preferences.protobuf.k0.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        public int d(int r11, byte[] r12, int r13, int r14) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.k0.e.d(int, byte[], int, int):int");
        }
    }

    static {
        f3711a = (!e.e() || AbstractC0318d.c()) ? new c() : new e();
    }

    public static String e(byte[] bArr, int i3, int i4) {
        return f3711a.a(bArr, i3, i4);
    }

    public static int f(CharSequence charSequence, byte[] bArr, int i3, int i4) {
        return f3711a.b(charSequence, bArr, i3, i4);
    }
    ...
    public static boolean m(byte[] bArr) {
        return f3711a.c(bArr, 0, bArr.length);
    }

    public static boolean n(byte[] bArr, int i3, int i4) {
        return f3711a.c(bArr, i3, i4);
    }
}
