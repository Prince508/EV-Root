...
public final class p extends AbstractC0432x implements P {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f1569a[AbstractC0432x.d.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1569a[AbstractC0432x.d.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1569a[AbstractC0432x.d.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1569a[AbstractC0432x.d.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f1569a[AbstractC0432x.d.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f1569a[AbstractC0432x.d.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends AbstractC0432x.a implements P {
        ...
        public b s(AbstractC0417h abstractC0417h) {
            m();
            ((p) this.f5998f).b0(abstractC0417h);
            return this;
        }
    ...
    public static p a0(AbstractC0417h abstractC0417h, C0425p c0425p) {
        return (p) AbstractC0432x.K(DEFAULT_INSTANCE, abstractC0417h, c0425p);
    }
